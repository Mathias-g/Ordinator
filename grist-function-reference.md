...
available. For more about using formulas in Grist, see [Intro to Formulas](https://support.getgrist.com/formulas/).

[Grist uses Python (version 3.11)](https://support.getgrist.com/python/) for formulas. You can use nearly all features of
...
- You may write multi-line Python in formulas (use `Shift + Enter` to
...
| Category | Functions |
| --- | --- |
| Grist | [Record](#record) or [rec](#record), [$Field](#field) or [rec.Field](#field), [$group](#group) or [rec.group](#group), [RecordSet](#recordset), [find.*](#find), [UserTable](#usertable), [all](#all), [lookupOne](#lookupone), [lookupRecords](#lookuprecords) |
| Cumulative | [NEXT](#next), [PREVIOUS](#previous), [RANK](#rank) |
| Date | [DATE](#date-1), [DATEADD](#dateadd), [DATEDIF](#datedif), [DATEVALUE](#datevalue), [DATE_TO_XL](#date_to_xl), [DAY](#day), [DAYS](#days), [DTIME](#dtime), [EDATE](#edate), [EOMONTH](#eomonth), [HOUR](#hour), [ISOWEEKNUM](#isoweeknum), [MINUTE](#minute), [MONTH](#month), [MOONPHASE](#moonphase), [NETWORKDAYS](#networkdays), [NOW](#now), [SECOND](#second), [TODAY](#today), [WEEKDAY](#weekday), [WEEKNUM](#weeknum), [XL_TO_DATE](#xl_to_date), [YEAR](#year), [YEARFRAC](#yearfrac) |
| Info | [CELL](#cell), [ISBLANK](#isblank), [ISEMAIL](#isemail), [ISERR](#iserr), [ISERROR](#iserror), [ISLOGICAL](#islogical), [ISNA](#isna), [ISNONTEXT](#isnontext), [ISNUMBER](#isnumber), [ISREF](#isref), [ISREFLIST](#isreflist), [ISTEXT](#istext), [ISURL](#isurl), [N](#n), [NA](#na), [PEEK](#peek), [RECORD](#record-1), [REQUEST](#request), [TYPE](#type) |
| Logical | [AND](#and), [FALSE](#false), [IF](#if), [IFERROR](#iferror), [NOT](#not), [OR](#or), [TRUE](#true) |
| Lookup | [lookupOne](#lookupone-1), [lookupRecords](#lookuprecords-1), [ADDRESS](#address), [CHOOSE](#choose), [COLUMN](#column), [COLUMNS](#columns), [CONTAINS](#contains), [GETPIVOTDATA](#getpivotdata), [HLOOKUP](#hlookup), [HYPERLINK](#hyperlink), [INDEX](#index), [INDIRECT](#indirect), [LOOKUP](#lookup-1), [MATCH](#match), [OFFSET](#offset), [ROW](#row), [ROWS](#rows), [SELF_HYPERLINK](#self_hyperlink), [VLOOKUP](#vlookup) |
| Math | [ABS](#abs), [ACOS](#acos), [ACOSH](#acosh), [ARABIC](#arabic), [ASIN](#asin), [ASINH](#asinh), [ATAN](#atan), [ATAN2](#atan2), [ATANH](#atanh), [CEILING](#ceiling), [COMBIN](#combin), [COS](#cos), [COSH](#cosh), [DEGREES](#degrees), [EVEN](#even), [EXP](#exp), [FACT](#fact), [FACTDOUBLE](#factdouble), [FLOOR](#floor), [GCD](#gcd), [INT](#int), [LCM](#lcm), [LN](#ln), [LOG](#log), [LOG10](#log10), [MOD](#mod), [MROUND](#mround), [MULTINOMIAL](#multinomial), [NUM](#num), [ODD](#odd), [PI](#pi), [POWER](#power), [PRODUCT](#product), [QUOTIENT](#quotient), [RADIANS](#radians), [RAND](#rand), [RANDBETWEEN](#randbetween), [ROMAN](#roman), [ROUND](#round), [ROUNDDOWN](#rounddown), [ROUNDUP](#roundup), [SERIESSUM](#seriessum), [SIGN](#sign), [SIN](#sin), [SINH](#sinh), [SQRT](#sqrt), [SQRTPI](#sqrtpi), [SUBTOTAL](#subtotal), [SUM](#sum), [SUMIF](#sumif), [SUMIFS](#sumifs), [SUMPRODUCT](#sumproduct), [SUMSQ](#sumsq), [TAN](#tan), [TANH](#tanh), [TRUNC](#trunc), [UUID](#uuid) |
| Schedule | [SCHEDULE](#schedule-1) |
| Stats | [AVEDEV](#avedev), [AVERAGE](#average), [AVERAGEA](#averagea), [AVERAGEIF](#averageif), [AVERAGEIFS](#averageifs), [AVERAGE_WEIGHTED](#average_weighted), [BINOMDIST](#binomdist), [CONFIDENCE](#confidence), [CORREL](#correl), [COUNT](#count), [COUNTA](#counta), [COVAR](#covar), [CRITBINOM](#critbinom), [DEVSQ](#devsq), [EXPONDIST](#expondist), [FDIST](#fdist), [FISHER](#fisher), [FISHERINV](#fisherinv), [FORECAST](#forecast), [F_DIST](#f_dist), [F_DIST_RT](#f_dist_rt), [GEOMEAN](#geomean), [HARMEAN](#harmean), [HYPGEOMDIST](#hypgeomdist), [INTERCEPT](#intercept), [KURT](#kurt), [LARGE](#large), [LOGINV](#loginv), [LOGNORMDIST](#lognormdist), [MAX](#max), [MAXA](#maxa), [MEDIAN](#median), [MIN](#min), [MINA](#mina), [MODE](#mode), [NEGBINOMDIST](#negbinomdist), [NORMDIST](#normdist), [NORMINV](#norminv), [NORMSDIST](#normsdist), [NORMSINV](#normsinv), [PEARSON](#pearson), [PERCENTILE](#percentile), [PERCENTRANK](#percentrank), [PERCENTRANK_EXC](#percentrank_exc), [PERCENTRANK_INC](#percentrank_inc), [PERMUT](#permut), [POISSON](#poisson), [PROB](#prob), [QUARTILE](#quartile), [RANK_AVG](#rank_avg), [RANK_EQ](#rank_eq), [RSQ](#rsq), [SKEW](#skew), [SLOPE](#slope), [SMALL](#small), [STANDARDIZE](#standardize), [STDEV](#stdev), [STDEVA](#stdeva), [STDEVP](#stdevp), [STDEVPA](#stdevpa), [STEYX](#steyx), [TDIST](#tdist), [TINV](#tinv), [TRIMMEAN](#trimmean), [TTEST](#ttest), [T_INV](#t_inv), [T_INV_2T](#t_inv_2t), [VAR](#var), [VARA](#vara), [VARP](#varp), [VARPA](#varpa), [WEIBULL](#weibull), [ZTEST](#ztest) |
| Text | [CHAR](#char), [CLEAN](#clean), [CODE](#code), [CONCAT](#concat), [CONCATENATE](#concatenate), [DOLLAR](#dollar), [EXACT](#exact), [FIND](#find-1), [FIXED](#fixed), [LEFT](#left), [LEN](#len), [LOWER](#lower), [MID](#mid), [PHONE_FORMAT](#phone_format), [PROPER](#proper), [REGEXEXTRACT](#regexextract), [REGEXMATCH](#regexmatch), [REGEXREPLACE](#regexreplace), [REPLACE](#replace), [REPT](#rept), [RIGHT](#right), [SEARCH](#search), [SUBSTITUTE](#substitute), [T](#t), [TASTEME](#tasteme), [TEXT](#text-1), [TRIM](#trim), [UPPER](#upper), [VALUE](#value) |
...
Learn more about [lookupOne](https://support.getgrist.com/references-lookups/#lookupone).
...
particular, methods like [`.find.le`](#find) allow searching for nearest values.
...
Learn more about [lookupRecords](https://support.getgrist.com/references-lookups/#lookuprecords).
...
`datetime.now()` updates only on reload. Use a [trigger formula](https://support.getgrist.com/formulas/#trigger-formulas) to
freeze the value.
...
`datetime.date.today()` updates only on reload. Use a [trigger formula](https://support.getgrist.com/formulas/#trigger-formulas)
to freeze the value.
...
> **Note** This function is not currently implemented in Grist.
...
Note that `VLOOKUP` isn't commonly needed in Grist, since [Reference columns](https://support.getgrist.com/col-refs/) are the
...
The `format` argument specifies the output format, according to this table:
  ...
  - `"*"` or `"E164"` - E164 format, like international but with no separators, e.g.
    `+12345678901`.
  - `"tel"` or `"RFC3966"` - format suitable to use as a [hyperlink](https://support.getgrist.com/col-types/#hyperlinks),
