...
adapted with two Ordinator-specific fields, `scope` and `interface-impact`
...
values, and sequential numbering (see ADR-0004).
...
- ADR-0004 (the decision to enforce the ADR format with automated checks)
