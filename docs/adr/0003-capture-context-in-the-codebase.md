...
The layers: exported identifiers and package docs for the public interface,
...
ADR-0004. Everything else is convention that `AGENTS.md` makes the path of
least resistance.

## More information

- ADR-0004 (the decision to enforce this process with automated checks)
